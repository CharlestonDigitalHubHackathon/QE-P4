...
export class WishlistService {
  ...
  public getTitle(): Observable<any> {
    return this._wishlist.title;
  }

  public getDescription(): Observable<any> {
    return this._wishlist.comment;
  }
}
